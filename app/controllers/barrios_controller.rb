class BarriosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @barrio.save
        format.html { redirect_to barrios_path, notice: 'Barrio Creado Correctamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @barrio.update_attributes(params[:barrio])
        format.html { redirect_to barrios_path, notice: 'Barrio Modificado Correctamente.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to barrios_url, notice: 'Barrio Eliminado Correctamente.'}
      format.json { head :no_content }
    end
  end
end
